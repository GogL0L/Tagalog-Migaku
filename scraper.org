...
#+begin_src fsharp :results output :session
let test_string = "stuff (isinasali, isinali, isasali) v., inf. include someone as a participant"
...
let result = infoToConjugations test_string2
...
#+RESULTS:
: type of hello: Microsoft.FSharp.Collections.FSharpList`1[System.String]
: the value of result: []
: val test_string : string =
:   "stuff (isinasali, isinali, isasali) v., inf. include someone "+[16 chars]
